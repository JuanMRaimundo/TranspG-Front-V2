		...
		<div className="bg-white p-2 md:p-3 rounded-2xl shadow-sm border border-slate-200 mb-6 flex flex-col md:flex-row items-center justify-between gap-3">
			...
			<div className="flex flex-col md:flex-row w-full md:w-auto gap-3 flex-1">
				...
				<div className="relative w-full md:w-56 group">
					...
					>
						...
						<option value="UNLOADED">Descargados</option>
						<option value="RETURNED">Playos</option>
						<option value="INVOICED">Facturados</option>
						<option value="CANCELLED">Cancelados</option>
						{/* PODRÍA AGREGAR UN CONDICIONAL PARA LOS FACTURADOS, QUE APAREZCA LA OPCIÓN SÓLO SI ES ADMINISTRADOR */}
					</select>
			...
			<div className="flex gap-2 w-full md:w-auto">
				...
				<button
					...
					className="flex-1 md:flex-none bg-green-600 hover:bg-green-700 text-white px-4 py-2.5 rounded-xl font-bold shadow-sm transition-all flex items-center justify-center gap-2"
				...
				{showCreateButton && (
					<button
						...
						className="flex-1 md:flex-none bg-brand hover:bg-brand-dark text-white px-5 py-2.5 rounded-xl font-bold shadow-md shadow-brand/20 hover:shadow-lg hover:shadow-brand/30 active:scale-95 transition-all flex items-center justify-center gap-2"
					>
